<aside class="admin-sidebar p-3" id="adminSidebar">
  ...
  <nav class="nav flex-column gap-1">
    <?php foreach (['dashboard.php'=>'Dashboard','pending_tutors.php'=>'Pending Tutors','all_tutors.php'=>'All Tutors','all_students.php'=>'All Students','subjects.php'=>'Subjects','bookings.php'=>'Bookings','payments.php'=>'Payments','reports.php'=>'Reports'] as $file => $label): ?>
